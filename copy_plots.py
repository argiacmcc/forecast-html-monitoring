...
###########
files = ['/work/csp/sp1/scratch/ICCLM2plot/'+year+month+'/clm_forcing_'+year+month+'.png', '/work/csp/sp1/CMCC-SPS3.5/WORK_IC4CAM/plots/'+year+month+'/Uprofile_'+year+month+'.png', '/work/csp/sp1/scratch/'+month+'/noaa_anom_'+year+month+'.png', '/work/csp/sp1/scratch/'+month+'/'+year+month+'01_all_anom.png']
